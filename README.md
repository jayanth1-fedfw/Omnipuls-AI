...
The platform includes an Omnipuls AI Copilot. If `OPENAI_API_KEY` is set, it calls the OpenAI Responses API. Without a key, it uses the built-in local action engine so the app still works.
